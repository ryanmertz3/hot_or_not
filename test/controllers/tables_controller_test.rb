...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { location: @table.location, number: @table.number, user_id: @table.user_id } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { location: @table.location, number: @table.number, user_id: @table.user_id } }
